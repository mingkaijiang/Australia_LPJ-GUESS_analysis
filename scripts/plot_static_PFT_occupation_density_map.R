plot_static_PFT_occupation_density_map <- function(myDF) {
    ...
    ## pdf
    pdf(paste0("output/static/PFT_TeNE_occupation_density_map.pdf"))
    plot(p1)
    dev.off()
    ...
    ## pdf
    pdf(paste0("output/static/PFT_TeBS_occupation_density_map.pdf"))
    plot(p2)
    dev.off()
    ...
    ## pdf
    pdf(paste0("output/static/PFT_IBS_occupation_density_map.pdf"))
    plot(p3)
    dev.off()
    ...
    ## pdf
    pdf(paste0("output/static/PFT_TeBE_occupation_density_map.pdf"))
    plot(p4)
    dev.off()
    ...
    ## pdf
    pdf(paste0("output/static/PFT_TrBE_occupation_density_map.pdf"))
    plot(p5)
    dev.off()
    ...
    ## pdf
    pdf(paste0("output/static/PFT_TrIBE_occupation_density_map.pdf"))
    plot(p6)
    dev.off()
    ...
    ## pdf
    pdf(paste0("output/static/PFT_TrBR_occupation_density_map.pdf"))
    plot(p7)
    dev.off()
    ...
    ## pdf
    pdf(paste0("output/static/PFT_C3G_occupation_density_map.pdf"))
    plot(p8)
    dev.off()
    ...
    ## pdf
    pdf(paste0("output/static/PFT_C4G_occupation_density_map.pdf"))
    plot(p9)
    dev.off()
